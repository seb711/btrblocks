...
install(FILES ${CROARING_LIBRARY_PATH} DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/croaring)
install(DIRECTORY ${CROARING_INCLUDE_DIR} DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/cmake/croaring)