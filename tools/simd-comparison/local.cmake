...
add_executable(btr_dyndict_simd_tests
        ${BTR_SIMD_COMPARISON_DIR}/test_driver.cpp
        ${BTR_SIMD_COMPARISON_DIR}/dyndict/dyndict_test.cpp)
target_link_libraries(btr_dyndict_simd_tests btrblocks gtest gmock Threads::Threads)
enable_testing()
add_test("btr_dyndict_simd_tests" btr_dyndict_simd_tests)
...
add_executable(btr_dyndict_simd_benchmarks
        ${BTR_SIMD_COMPARISON_DIR}/dyndict/dyndict_benchmark.cpp)
target_link_libraries(btr_dyndict_simd_benchmarks btrblocks tbb gmock Threads::Threads)
